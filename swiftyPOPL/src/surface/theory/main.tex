...
The omitted homomorphic rules translate literals, variables, calls, field access, construction, conditionals, and primitive operators structurally to the corresponding core form described above.
They do not create new type abstractions, dictionaries, or existential packages.
...
\paragraph{Lemma 9: Function wrappers preserve typing.}
Let
\[
  \sigma=
  \ftype{\overline{X_i:\overline{P_i}}}
...
Lemma 9 gives that the generated wrapper has exactly the translated function-scheme type.
...
Lemma 9 types the generated function wrapper at $\trans{\sigma}$.
...
Lemma 9 then gives the generated binding the translated function-scheme type.
