...
(lambda x:Bool. x) (error true);

try error with 5;
try error with false;

try if iszero(5) then true else error with false;

if true then error else 5;
if false then 5 else error 666;
if false then error else error;
